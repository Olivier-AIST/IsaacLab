    ...
    class JointStatePublisher(Node):
        def __init__(self):
            ...
            self.joint_names = [
                ...
                "fr3_joint4", "fr3_joint5", "fr3_joint6", "fr3_joint7","finger1","finger2"
            ]
        ...
        def publish_actions(self, actions_tensor):
            ...
            # 7 first 1 ok
            msg.position = [float(x) for x in actions_tensor[0][:7].tolist()]+[float(actions_tensor[0][7])+float(actions_tensor[0][8])]
            # msg.position = [0.0] + [float(actions_tensor[0][1])] + [0.0] * 5
